        ...
        <div className="step-content">
          <div className="step-inner-content">
            ...
            <p className="step-description">
              select the specific quote for approval
            </p>
          </div>
          <span
            className={expandedStep === 4 ? "chevron-down" : "chevron-right"}
          ></span>
        </div>
        <div
          className={`expanded-content ${expandedStep === 4 ? "open" : ""}`}
        ...
        >
          {quotes.map((quote, index) => (
            <div className="quotation-buttons" key={index}>
              ...
              >
                {selectedQuote[index] === "Not Selected"
                  ? "select this quote"
                  : selectedQuote[index]}
              </button>
            </div>
